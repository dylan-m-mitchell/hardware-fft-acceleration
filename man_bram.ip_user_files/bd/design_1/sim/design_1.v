...
module design_1
  ...
  wire [127:0]DummyFFT_0_o_128;
  wire DummyFFT_0_o_DV;
  wire [4:0]DummyFFT_0_o_Rd_Addr;
  wire DummyFFT_0_o_Rd_En;
  wire [4:0]DummyFFT_0_o_Wr_Addr;
  ...
  wire [4:0]to_ram_0_o_wr_addr;
  wire [127:0]to_ram_0_o_wr_data;
  wire to_ram_0_o_wr_dv;

  design_1_DummyFFT_0_0 DummyFFT_0
       (.i_128(RAM64_0_o_Rd_Data),
        .i_Data_Rd(1'b0),
        .i_Rd_DV(RAM64_0_o_Rd_DV),
        .i_clk(clk_in1_0),
        .o_128(DummyFFT_0_o_128),
        .o_DV(DummyFFT_0_o_DV),
        .o_Rd_Addr(DummyFFT_0_o_Rd_Addr),
        .o_Rd_En(DummyFFT_0_o_Rd_En),
        .o_Wr_Addr(DummyFFT_0_o_Wr_Addr));
