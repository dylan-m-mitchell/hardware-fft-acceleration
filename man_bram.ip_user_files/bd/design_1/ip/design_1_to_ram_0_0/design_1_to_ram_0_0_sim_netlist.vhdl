...
architecture STRUCTURE of design_1_to_ram_0_0_to_ram is
  ...
  signal \o_wr_addr[0]_i_1_n_0\ : STD_LOGIC;
  signal \o_wr_addr[1]_i_1_n_0\ : STD_LOGIC;
  signal \o_wr_addr[2]_i_1_n_0\ : STD_LOGIC;
  signal \o_wr_addr[3]_i_1_n_0\ : STD_LOGIC;
  signal \o_wr_addr[4]_i_1_n_0\ : STD_LOGIC;
  signal \o_wr_addr[4]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \byte_cnt[1]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of o_Data_Rd_i_2 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \o_wr_addr[4]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of state : label is "soft_lutpair3";
begin
...
o_Data_Rd_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
o_Data_Rd_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\o_wr_addr[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I2 => \^q\(1),
      I3 => \^q\(3),
      O => \o_wr_addr[3]_i_1_n_0\
    );
\o_wr_addr[4]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => i_rst_n,
      O => \o_wr_addr[4]_i_1_n_0\
    );
\o_wr_addr[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6CCCCCCC"
    )
        port map (
...
entity design_1_to_ram_0_0 is
  port (
    ...
    i_rst_n : in STD_LOGIC;
    o_Data_Rd : out STD_LOGIC;
    o_wr_addr : out STD_LOGIC_VECTOR ( 4 downto 0 );
    o_wr_dv : out STD_LOGIC;
    o_wr_data : out STD_LOGIC_VECTOR ( 127 downto 0 )
  );
...
inst: entity work.design_1_to_ram_0_0_to_ram
     port map (
      Q(4 downto 0) => o_wr_addr(4 downto 0),
      i_clk => i_clk,
      i_d_valid => i_d_valid,
