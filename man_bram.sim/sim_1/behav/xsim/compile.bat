...
REM
REM Generated by Vivado on Thu Mar 26 21:57:35 -0500 2026
...
echo "xvlog --incr --relax -prj ram_to_fft256_bridge_tb_vlog.prj"
call xvlog  --incr --relax -prj ram_to_fft256_bridge_tb_vlog.prj -log xvlog.log
