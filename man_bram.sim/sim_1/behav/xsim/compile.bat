...
REM
REM Generated by Vivado on Mon Feb 16 15:22:02 -0600 2026
...
echo "xvlog --incr --relax -prj to_ram_tb_vlog.prj"
call xvlog  --incr --relax -prj to_ram_tb_vlog.prj -log xvlog.log
